...
def _render_performance_lead_mix(
    ...
    named_set = {"Referral","Event","Organic","PM - Search","PM - Social"}
    ...
    try:
        ...
        for lab, src in windows:
            if src == "__REMAINING__":
                ...
                name_map = {"B":"Referral","C":"Event","D":"Organic","E":"PM - Search","F":"PM - Social"}
    ...
    for label, src in windows:
        dfw = df.copy()
        if _source and _source in dfw.columns:
            if src == "All" or src is None:
                pass
            elif src == "__REMAINING__":
                _used = {"Referral","Event","Organic","PM - Search","PM - Social"}
                dfw = dfw[~dfw[_source].astype(str).isin(list(_used))]
            else:
