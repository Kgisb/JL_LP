...
with st.sidebar:
    ...
    MASTER_SECTIONS = {
        "Performance": ["Cash-in","Dashboard","MIS","Daily Business","Sales Tracker","AC Wise Detail","Leaderboard", "Quick View", "Comparison", "Call Talk-time Report", "Pipeline", "Sales Activity", "Deal stage", "Original source","Lead mix", "Referral performance", "Slow Working Deals", "Activity concentration"],
        ...
        "Marketing": ["Referrals","Referral / No-Referral","HubSpot Deal Score tracker","Marketing Lead Performance & Requirement"],
    }
